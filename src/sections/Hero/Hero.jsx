  ...
  return (
    <section id="hero" className={styles.container}>
      ...
      <div className={styles.info}>
        ...
        <h2>Data Analyst</h2>
        <span>
          <a href="https://www.youtube.com/watch?v=ZpIel9cv4Jk&t=122s/" target="_blank">
        ...
        With a strong background in business, I harness the power of data to drive transformative change.
        </p>
        <a href={CV} download>
